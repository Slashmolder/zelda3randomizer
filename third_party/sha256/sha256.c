...
*               - BYTE → SHA256_BYTE, WORD → SHA256_WORD throughout
*                 (avoid collision with src/types.h's BYTE/WORD macros).
...
/* Convenience wrapper added by zelda3randomizer vendoring (not in upstream). */

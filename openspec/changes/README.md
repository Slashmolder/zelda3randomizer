...
Total: 1 active change (`add-rando-switch-swkbd`) + 34 archived. The archived set currently contains 30 randomizer/randomizer-adjacent changes, 2 native-UI changes, and 2 non-rando JP-feature changes. Run `openspec validate --changes` to confirm all validate.

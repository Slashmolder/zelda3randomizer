...
| **B** | 4b | [`add-rando-retro-world-state`](add-rando-retro-world-state/) | Retro shop dispatch + 3 Retro flag pin (rupeeBow/takeAnys/wildKeys); genericKeys carved to #4b-i | As-built (rupeeBow + wildKeys + text Shops + JSON shops[]; spec reconciled, kGenVer 53) — **archive-gate: owner playtest** | **Yes** | ✅ built — playtest-pending |

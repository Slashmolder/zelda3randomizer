...
| **B** | 2 | [`add-rando-trackers`](add-rando-trackers/) | Trackers — shipped as **3 native ImGui windows on PC** (Item / Check tri-state / Map); legacy `hud.c` OAM overlay = Switch path; checked-bitmap r/w (audited 2026-06-02, no HIGH) | Full (built + audited; **open: PC playtest + archive**) | No | 1-2w |

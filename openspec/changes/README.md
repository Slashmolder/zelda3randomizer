...
| **B** | 1 | [`add-rando-confirmation-icons`](add-rando-confirmation-icons/) | Visible direct-grant icon ancilla (extends §7.6 audio-only) | Full (28/34) — **archive-blocker: owner playtest §7.1-7.3 only**; deltas are clean | No | 3-5d |

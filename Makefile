...
src/rando/logic_data.c: rando-codegen-force $(RANDO_GEN_SRCS)
	@echo "Regenerating rando codegen: src/rando/{logic_data.c, location_ids.h, item_ids.h, chest_lookup.h, pot_lookup.h, terrain_lookup.h, enemy_drop_lookup.h, enemy_check_lookup.h, pot_nonpot_drop_counts.h, icon_atlas.h, direct_grant_icons.h}"

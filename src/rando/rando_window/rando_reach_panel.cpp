...
// add-rando-pot-sanity — pot_shuffle can add ~800 pot checks; pot ROWS are gated
// behind a "Show pots" toggle (default off) so the per-region tables stay usable.
// Counts always include pots, matching the Check Tracker. LOCTYPE_Pot (17) from
// rando_logic.h.

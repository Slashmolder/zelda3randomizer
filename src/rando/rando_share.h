...
#define kShareStringV2BinaryLen (16 + kSettingsCanonicalLen)  // 44 today

// Text-buffer bound for encode/decode (string + NUL). Sized with headroom
// beyond the current 71-char v2 string so a future canonical growth doesn't
...
// Returns the number of chars written (71 at the current canonical length,
...
// (D7). The TYPICAL v2 string (71 chars) cannot fit kRandoTextFieldMaxLen

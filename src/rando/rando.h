...
// ---------------------------------------------------------------------------
#define kGeneratorVersion 77u  // 76→77: MM/TR medallion config slots no longer behave like item placements in spoilers, hints, accessibility, or sphere item grants. Text/JSON spoilers emit actual medallion requirements from the assignment table. Hints-on JSON/race stamps can change; seeds that previously used fake config-slot medallions for reachability may move. settings_hash unchanged.

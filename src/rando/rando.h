...
// ---------------------------------------------------------------------------
#define kGeneratorVersion 40u  // Phase C Stage 2 — Eastern Palace added to the dungeon-shuffle pool (7→8). Default seeds still byte-identical; dungeon-shuffle digests change.

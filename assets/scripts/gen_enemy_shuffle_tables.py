...
sheet-id facts, not extracted ROM data). See assets/rando/ENEMIZER_PIN.md for
the source commit and update policy.
"""
import re, sys, os
...
print(f"// === GENERATED by gen_enemy_shuffle_tables.py (Enemizer MIT source; see assets/rando/ENEMIZER_PIN.md) ===")
